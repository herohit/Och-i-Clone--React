    ...
    return (
        <div className='w-full h-screen bg-zinc-900 p-20 flex '>
            <div className='w-1/2 h-full flex flex-col justify-between'>
                <div style={{ fontFamily: 'FounderGrotesk' }} className="heading ">
                    <h1 className='text-[10vw] leading-none -mb-10' >EYE-</h1>
                    <h1 className='text-[10vw] leading-none'>OPENING</h1>
                </div>
            ...
            <div className='w-1/2'>
                <div style={{ fontFamily: 'FounderGrotesk' }} className="heading ">
                    <h1 className='text-[9vw] leading-none -mb-10' >PRESENTATIONS</h1>
                    <div style={{ fontFamily: 'Neue' }} className="dets mt-20 flex flex-col gap-5 text-2xl underline">
                        <a href="#">Facebook</a>
                        <a href="#">Twitter</a>
                        <a href="#">Instagram</a>
                    </div>
